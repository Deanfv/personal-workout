...
assert.strictEqual(L.GUTCHECK_SETS, 10);
assert.strictEqual(L.GUTCHECK_SET_REPS, 10);
...
assert.strictEqual(L.gutcheckRepsFromSets([{done:true}]), 10, 'Done set with no reps counts as 10');
...
assert.ok(html.indexOf('Not the day before you play. RPE 6–7. Sets of 10.') !== -1);
